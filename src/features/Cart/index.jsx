...
class Cart extends Component {
  ...
  <table id="cart" className="table table-hover table-condensed">
    ...
    <tbody>
      <tr>
        ...
        <td className="actions" data-th>
          ...
          <button className="btn btn-danger btn-sm"><i className="fas fa-trash" />
          </button>
        </td>
      </tr>
      <tr>
        <td data-th="Product">
          <div className="row">
            <div className="col-sm-2 hidden-xs"><img src="http://hocwebgiare.com/thiet_ke_web_chuan_demo/shopping_cart/images/090.jpg" alt="Sản phẩm 2" className="img-responsive" width={100} />
            </div>
            <div className="col-sm-10">
    ...
    <tfoot>
      ...
      <tr>
        <td><a href className="btn btn-warning"><i className="fa fa-angle-left" /> Tiếp tục mua hàng</a>
        </td>
        <td colSpan={2} className="hidden-xs" />
        <td className="hidden-xs text-center"><strong>Tổng tiền 500.000 đ</strong>
        </td>
        <td><a href style={{backgroundColor: '#fed700'}} className="btn btn-success btn-block">Thanh toán <i className="fa fa-angle-right" /></a>
        </td>
      </tr>
    </tfoot>
  </table>
