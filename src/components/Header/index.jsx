      ...
      <header className="header">
        <div className="grid wide">
          ...
          "
              >
                ...
                <div className="header__qr">
                  <img src="" alt="QR code" className="header__qr-img" />
              ...
              <li className="header__navbar-item">
                ...
                <a href="/#" className="header__navbar-icon-link">
                  <i className="header__navbar-icon fab fa-instagram-square" />
                </a>
              </li>
            </ul>
            <ul className="header__navbar-list">
              <li className="header__navbar-item header__navbar-item--has-notify">
                <a href="/#" className="hearder__navbar-item-link">
                ...
                <div className="header__notify">
                  ...
                  <ul className="header__notify-list">
                    <li className="header__notify-item header__navbar-item--notviewed">
                      <a href="/#" className="header__notify-link">
                        <img
                          src="https://img.abaha.vn/photos/resized/200x120/121-1608210033-demoweb.png"
                          alt=""
                          className="header__notify-img"
                        />
                        <div className="header__notify-info">
                          <span className="header__notify-name">
                            SIÊU PHẨM MỚI: KEM NỀN DẠNG THỎI OHUI ULTIMATE COVER
                            STICK FOUNDATION
                          </span>
              ...
              {isLoggedIn && (
                <>
                  <li className="header__navbar-item header__navbar-user">
                    <img
                      src="https://images.unsplash.com/photo-1633114072497-8d1f29467718?ixlib=rb-1.2.1&ixid=MnwxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80"
                      alt=""
                      className="header__navbar-user-img"
                    />
                    <div className="header__navbar-user-name">Phúc Hoàng</div>
          ...
          <div className="header-with-search">
            <input type="checkbox" hidden id="mobile-bar-checkbox" className ="" />
            <label htmlFor="mobile-bar-checkbox" className="header__mobile-bar">
              <i className="header__mobile-bar-icon fas fa-bars" />
            </label>
            <ul className="header__mobile-nav">
              ...
              <label
                htmlFor="mobile-bar-checkbox"
                className="header__mobile-bar-close"
              >
                ...
                <div className="header__cart-list">
                  ...
                  <ul className="header__cart-list-item">
                    <li className="header__cart-item">
                      <img
                        src="https://cf.shopee.vn/file/e0db6bc6c3d41f4c0058f514c12456c5"
                        alt=""
        ...
        <ul className="header__sort-bar">
          <li className="header__sort-item header__sort-item--active">
            <a href="/#" className="header__soft-link">
              Liên quan
            </a>
          </li>
